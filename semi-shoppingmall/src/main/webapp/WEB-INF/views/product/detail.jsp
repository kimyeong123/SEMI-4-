...
$(function() {
    ...
    $(document).on("click", ".btn-edit", function() {
        ...
        if(contentTd.find("textarea").length > 0) return; // 이미 수정중이면 패스
...
<div class="container w-800">
    ...
    <div id="wishlist-heart" style="cursor: pointer; font-size: 24px; display: inline-block; margin-top: 10px;">
        <c:choose>
    ...
    <table border="1" width="100%">
        ...
        <tr><th>가격</th><td>${product.productPrice}</td></tr>
        <tr><th>설명</th><td>${product.productContent}</td></tr>
        <tr><th>평균 평점</th><td>${reviewService.selectAverageRating(product.productNo)}</td></tr>
    </table>
        ...
        <tbody>
            <c:forEach var="review" items="${reviewList}">
                <tr id="review-${review.reviewNo}">
                    ...
                    <td>
                        <c:if test="${sessionScope.loginId == review.memberId}">
